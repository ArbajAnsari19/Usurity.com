  ...
  const tabContent = {
    'Risk Assessment': (
      <div className="flex flex-col lg:flex-row gap-8 p-8">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center">
          <h2 className="text-5xl font-bold text-[rgba(188,124,228,0.85)] mb-[70px]">Risk Assessment</h2>
    ...
    'Policy Analysis': (
        <div className="flex flex-col lg:flex-row gap-8 p-8">
          {/* Left Panel */}
          <div className="lg:w-1/2 flex flex-col justify-center">
            <h2 className="text-5xl font-bold text-[rgba(188,124,228,0.85)] mb-[70px]">Policy Analysis</h2>
            <p className="text-gray-700 text-lg mb-8">
    ...
    'Compliance Review': (
        <div className="flex flex-col lg:flex-row gap-8 p-8">
          {/* Left Panel */}
          <div className="lg:w-1/2 flex flex-col justify-center">
            <h2 className="text-5xl font-bold text-[rgba(188,124,228,0.85)] mb-[70px]">Compliance Review</h2>
            <p className="text-gray-700 text-lg mb-8">
    ...
    'Claims Management': (
      <div className="flex flex-col lg:flex-row gap-8 p-8">
        {/* Left Panel */}
        <div className="lg:w-1/2 flex flex-col justify-center">
          <h2 className="text-5xl font-bold text-[rgba(188,124,228,0.85)] mb-[70px]">Claims Management</h2>
          <p className="text-gray-700 text-lg mb-8">
    ...
    'Data Processing': (
      <div className="flex flex-col lg:flex-row gap-8 p-8">
        {/* Left Panel */}
        <div className="lg:w-1/2 flex flex-col justify-center">
          <h2 className="text-5xl font-bold text-[rgba(188,124,228,0.85)] mb-[70px]">Data Processing</h2>
          <p className="text-gray-700 text-lg mb-8">
