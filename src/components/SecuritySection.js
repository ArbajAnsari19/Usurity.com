    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <span className="inline-block bg-[rgba(188,124,228,0.85)] text-white px-4 py-2 rounded-full text-sm font-medium">
            Security
          </span>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              {securityFeatures.map((feature, index) => (
                <div key={index} className="flex items-start space-x-4">
                  <div className="text-[rgba(188,124,228,0.85)] mt-0.5 flex-shrink-0">
                    {feature.icon}
                  </div>
          ...
          <div className="flex flex-col items-center">
            {/* Main Security Card */}
            <div className="bg-gradient-to-br from-[rgba(188,124,228,0.85)] to-[rgba(188,124,228,0.5)] rounded-2xl p-8 w-full max-w-lg relative overflow-hidden">
              {/* Background Pattern */}
