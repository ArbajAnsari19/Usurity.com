        ...
        <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 lg:p-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-video bg-gradient-to-br from-[rgba(188,124,228,0.35)] to-[rgba(188,124,228,0.5)] rounded-xl flex items-center justify-center relative overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-[rgba(188,124,228,0.35)] rounded-full mt-2"></div>
