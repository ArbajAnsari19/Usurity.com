        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              ...
              <span data-label=" " style={{'--i': 8}}>  </span>
              <span data-label="d" style={{'--i': 9}}>d</span>
              <span data-label="e" style={{'--i': 10}}>e</span>
              <span data-label="m" style={{'--i': 11}}>m</span>
              <span data-label="o" style={{'--i': 12}}>o</span>
            </span>
            <div className="icon">
              <div />
            </div>
            <span className="char state-2">
              ...
              <span data-label="e" style={{'--i': 10}}>d</span>
            </span>
          </div>
        </div>
      </button>
